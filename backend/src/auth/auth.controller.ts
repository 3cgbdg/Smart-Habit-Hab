...
export class AuthController {
  ...
  @Post("signup")
  async signup(@Body() dto: GeneralAuthDto, @Res() res: Response): Promise<Response<any, Record<string, any>>> {
  ...
  @Post("login")
  async login(@Body() dto: GeneralAuthDto, @Res() res: Response): Promise<Response<any, Record<string, any>>> {
