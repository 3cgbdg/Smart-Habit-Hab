...
const ExperimentDetailInfo = ({ experiment }: ExperimentDetailInfoProps) => {
    ...
    return (
        ...
        >
            <Box sx={{ p: 3, bgcolor: 'var(--color-lightBlue)', borderBottom: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Box sx={{ p: 4 }}>
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 4 }}>
                    ...
                    <Box>
                        ...
                        <Box sx={{ p: 2, bgcolor: 'grey.50', borderRadius: 2, border: '1px solid', borderColor: 'grey.100' }}>
